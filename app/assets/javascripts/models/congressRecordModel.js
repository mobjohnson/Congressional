App.CongressRecordModel = Backbone.Model.extend({
  ...
  url: function(){
    return "//capitolwords.org/api/1/dates.json?phrase=" + this.phrase + "&state=" + this.state + "&start_date= 2014-01&end_date=2015-02&granularity=month&apikey=3fdb489020354ae7b4e1a1bf75b4a279"
  },
